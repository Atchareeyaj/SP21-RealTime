...
class Scene {
  ...
  addSelf() {
    ...
    let mat = new THREE.MeshBasicMaterial({color : 0x8B31FF});

    let _head = new THREE.Mesh(new THREE.SphereGeometry( 0.5, 40,40), videoMaterial);
    let _body = new THREE.Mesh(new THREE.CylinderGeometry( 0.1, 0.5,1 ,40), mat);

    _head.position.set(0, 0.8, 0);
  ...
  addClient(_id) {
    ...
    let mat = new THREE.MeshBasicMaterial({color : 0xFFA631});
