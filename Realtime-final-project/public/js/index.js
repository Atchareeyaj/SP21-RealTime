...
window.onload = async () => {
  ...
  glScene.controlUpdate = true;
  // console.log(glScene.controlUpdate); 
    const container = document.querySelector(".container");
    container.style.display = "none"
    glScene.userColor = col.value;
    // console.log("from indexJS " + message);
    // socket.emit('request',{msg: msg.value, bd: bd.value,col:col.value});

    console.log('msg value' + msg.value);
    console.log('bd value' + bd.value);
    console.log('col value' + col.value); 

    msgVal = msg.value;
    bdVal = bd.value;
    colVal = col.value;
    let fetchQurey = '/success?msg='+msgVal+'&bd='+bdVal+'&col='+colVal;
    console.log(fetchQurey)
    fetch(fetchQurey)
